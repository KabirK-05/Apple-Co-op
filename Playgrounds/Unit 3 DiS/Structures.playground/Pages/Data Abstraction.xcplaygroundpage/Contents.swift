...
func songInformation(songTitle: Int) -> String {
    /* Return a string describing the song,
     e.g. "\"Maybe\" by Brenda and the Del-chords, duration 200 seconds"
     */
    return ("\(songTitles[songTitle]) by \(artists[songTitle]), duration \(durations[songTitle]) seconds")
}


print(songInformation(songTitle: 1))
