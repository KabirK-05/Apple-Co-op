...
let total = impossibleBeliefsCount(pigsFlying: 2, frogsBecomingPrinces: 3, multipleLightningStrikes: 4)
print(impossibleThingsPhrase(numberOfImpossibleThings: total, meal: "teatime"))
