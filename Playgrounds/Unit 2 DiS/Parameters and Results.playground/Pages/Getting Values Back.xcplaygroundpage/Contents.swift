 ...
 */
func podiumPointScoring(driver:String, position:Int){
    var points = 0
    if position == 1{
        points = 25
    }
    ...
    print("\(driver) won \(points) points by placing P\(position)")
    
}
/*:
[Previous](@previous)  |  page 6 of 18  |  [Next: Giving Values Back](@next)
 */
podiumPointScoring(driver: "Max Verstappen", position: 1)
