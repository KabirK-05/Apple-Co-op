...
let totalMorningTime = brushTeeth+takeShower+wearClothes+eatBreakfast+watchNews+usePhone+playPiano
/*:
 ...
 */
let haveToDo = brushTeeth+takeShower+wearClothes+eatBreakfast
let likeToDo = watchNews+usePhone+playPiano
/*:
