...
let typesInStrings = "Strings can contain numbers, however they cannot be used to perform calculations"
let addingStrings = "Using the '+' operator with strings will combine 2 together"
let exampleInt = 4
let nameInString = "Using backslash can insert a constant or variable into a string like so: \(exampleInt)"
