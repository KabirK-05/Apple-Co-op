...
let qualiPos = 1
let rainLap = 49
let landoNorrisReport = "On Saturday Lando Norris Achieved his first pole position qualifying P\(qualiPos). Although with late rain on lap \(rainLap), Lando Norris didn't pit and in the end cost him his maiden win."
print(landoNorrisReport)
/*:
